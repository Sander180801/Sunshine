...
public class TestUriMatcher extends AndroidTestCase {
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error",testMatcher.match(TEST_WEATHER_DIR),WeatherProvider.WEATHER);
        assertEquals("Error",testMatcher.match(TEST_WEATHER_WITH_LOCATION_DIR),WeatherProvider.WEATHER_WITH_LOCATION);
        assertEquals("Error",testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR),WeatherProvider.WEATHER_WITH_LOCATION_AND_DATE);
        assertEquals("Error",testMatcher.match(TEST_LOCATION_DIR),WeatherProvider.LOCATION);
