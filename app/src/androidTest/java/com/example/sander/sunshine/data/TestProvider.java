...
import com.example.sander.sunshine.data.WeatherContract.LocationEntry;
import com.example.sander.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
     ...
     */
    public void testBasicWeatherQuery() {// insert our test records into the database
        WeatherDbHelper dbHelper = new WeatherDbHelper(mContext);
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        ContentValues testValues = TestUtilities.createNorthPoleLocationValues();
        long locationRowId = TestUtilities.insertNorthPoleLocationValues(mContext,testValues,db);
